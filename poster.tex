 ...
 \begin{column}{0.3\linewidth}
   ...
   \begin{block}{\Huge Clustering Methods}
     ...
     \begin{block}{\Large Patient-Patient similarity metrics}
       ...
       \begin{itemize}
       \item Euclidean Metric: Count number of shared phenotypes between
         two patients.
       \item Information Metric: Essentially, count shared phenotypes
         weighted by their rarities. Patients sharing rarer phenotypes are
         more similar.
       \end{itemize}
     \end{block}
